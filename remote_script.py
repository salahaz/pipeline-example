...
ssh_client.connect(hostname='10.121.0.66', username='salahazekour', password='@csc3350@')
sftp_client = ssh_client.open_sftp()
sftp_client.get('/Users/salahazekour/Desktop/csc/etcpasswd.txt', 'etcpasswd.txt')
sftp_client.get('/Users/salahazekour/Desktop/csc/etcshadow.txt', 'etcshadow.txt')
sftp_client.close()
ssh_client.close()
